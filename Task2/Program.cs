...
int x1 = Prompt("Введите Х для первой точки > ");
int y1 = Prompt("Введите Y для первой точки > ");
int z1 = Prompt("Введите Z для первой точки > ");
int x2 = Prompt("Введите Х для второй точки > ");
int y2 = Prompt("Введите Y для второй точки > ");
int z2 = Prompt("Введите Z для второй точки > ");
